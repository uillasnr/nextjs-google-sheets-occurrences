...
export default function Filtros({
  ...
  const filtros = [
    {
      valor: "NF DISPONIVEIS",
      label: "Disponíveis",
      classe: "from-blue-500 to-blue-600",
    },
    {
      valor: "AGUARDANDO",
      label: "Aguardando",
    ...
    },
    {
      valor: "EXPEDIDO",
      label: "Expedido",
      classe: "from-emerald-500 to-emerald-600",
    },
    {
      valor: "TODOS",
      label: "Todas",
      classe: "from-gray-500 to-gray-600",
    },
  ] as const;

  return (
    <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-2xl p-5 space-y-4 shadow-sm">
      {/* Busca */}
          ...
          className={`w-full pl-12 pr-4 py-3.5 rounded-xl font-medium transition-all duration-200
            ${
              romaneioAtivo
                ...
                : "bg-gray-50 dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            }`}
        />
      </div>
                ...
                className={`px-4 py-2 rounded-xl font-bold text-sm transition-all duration-200
                  ${
                    romaneioAtivo
                      ...
                      : ativo
                        ? `bg-gradient-to-r ${classe} text-white shadow-md`
